...
public class PlayerControlls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp(controllerRB))
        {
            HandleGrab(null, amIGrabbing);
        }
    }
    ...
    {
        if (collision.collider.gameObject.layer == LayerMask.NameToLayer("Grabbable Object")
            && !amIGrabbing)
        {
    ...
    {
        if (collision.collider.gameObject.layer == LayerMask.NameToLayer("Grabbable Object")
            && Input.GetKeyDown(controllerRB))
        {
            HandleGrab(collision, amIGrabbing);
        }
    }
    ...
    void HandleGrab(Collision c, bool amIGrab)
    {
        if (!amIGrab)
        {
            if (!amIGrab && c != null)
            {
                ...
                c.collider.gameObject.transform.localPosition = pickUpPosition.localPosition;
